			...
			<div class="col-md-4 offset-md-4">
				<div class="car_paint-card">
					<div class="card-body">
						...
						<% 
						 String str=(String)session.getAttribute("regi_success");
						
						if(str!=null){
							%>
							<p class="text-center text-danger fs-5"><%= str %></p>
							<% 
							session.removeAttribute("regi_success");
						}
						 %>
						...
						<div class="mb-3">
							...
							<center><a href="../user/user_login.jsp">Existing User?Go to Login</a></center>
						</form>
