		...
		<div class="row">
			<div class="col-md-4 offset-md-4">
				<div class="car_paint-card">
					<div class="card-body">
						<p class="fs-4 text-center">Search Event</p>
						<% 
						...
						<form action="../event/search_event" method="post">
						<div class="mb-3">
							<div class="mb-3">
							...
							<div class="mb-3">
								<label class="form-label">Event Date</label> <input
									name="event_date" type="text" class="form-control" required>
							</div>
							
							<button type="submit" class="btn bg-primary text-white col-md-12">Search</button>
							</div>
						</form>
